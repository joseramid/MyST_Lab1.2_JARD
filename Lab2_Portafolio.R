...
#Similar a Python, cuando entre corchetes pones una coma y luego dejas el espacio vacio
#es para indicar que de la presente fila todas las columnas, o si estuviera el espacio vacio
#al principio, seria todas las filas para la presente columna.

# Portafolio con mínima varianza
Port_2 <- df_Portafolios[which.min(df_Portafolios$Var),]
#la herramienta which elige.

# Tasa libre de riesgo (obtenida de treasury.gov para el viernes 7 de septiembre)
rf <- 0.0253         
...
# Encontrar las columnas cuyo nombre contenga "Titulos_ini", con esas encontraremos
#más fácil los títulos
...
#En Historicos_Ports se observa una matriz con los saldos resultantes de optar por esa
#estrategia, es por eso que empieza rondando por los 10000 porque fue lo que declaramos
...
#Aqui se grafica la linea de tiempo.
